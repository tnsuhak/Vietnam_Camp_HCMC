...
['TAS Grade 3도 지금 등록할 수 있나요?','현재 Grade 3 직접 등록은 마감되었습니다. 다만 운영사 안내에 따라 학년을 한 단계 올리거나 내리는 방식의 등록은 가능하므로 상담 시 배정 가능 학년을 확인해야 합니다.'],
...
['공항 픽업과 드롭도 제공되나요?','프로그램 자료에는 도착 시간에 맞춘 공항 픽업·드랍 차량 제공이 안내되어 있습니다. 실제 차량 배정 방식은 항공편 정보 제출 후 최종 안내됩니다.'],
['항공권과 출국은 단체 출국인가요?','현재 제공된 프로그램 자료에는 단체 지정 항공편 또는 개별 출국 여부가 명시되어 있지 않습니다. 다만 도착 시간에 맞춘 공항 픽업·드랍 지원은 안내되어 있으므로 항공권 예약 전 최종 출국 방식을 확인하는 것이 좋습니다.'],
...
['등록 전에 마지막으로 무엇을 확인해야 하나요?','학년별 잔여 자리, 특히 TAS Grade 3 대체 배정 가능 여부, 정확한 일정, 숙소 객실 타입, 포함·불포함 항목과 항공편 관련 안내를 상담 시 최종 확인하는 것이 좋습니다.']
];
